...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService("AuthService",
                ...
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "fd7e8fdd13de53dda7f1f82c36f2723dac3429d477b42f7affa76f721e47f481"));
    ...
    // an ECS service that makes it easier to start, stop and scale
    private FargateService createFargateService(String id,
        ...
        if (db != null) {
            envVars.put("SPRING_DATASOURCE_DATABASE_URL", "jdbc:postgresql://%s:%s/%s-db".formatted(
    ...
    public static void main(String[] args) {
        ...
        StackProps props = StackProps.builder()
                ...
                .build();
        new LocalStack(app, "localcontainer", props);
        app.synth();
